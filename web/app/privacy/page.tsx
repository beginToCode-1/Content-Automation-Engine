  ...
  return (
    <>
      ...
      <div className="doc-page">
        ...
        <p>
          Content Engine is a self-hosted application. It runs on the operator&apos;s own computer and is not a
          hosted service operated by a separate company. There is no remote server collecting your data on the
          developer&apos;s behalf. This policy describes how the application itself handles data on the machine it
          runs on, and which third-party services it connects to on your behalf.
        </p>

        <h2>Data This Application Stores Locally</h2>
        <p>
          All of the following is stored only in a local SQLite database and local files on the machine running the
          application, never transmitted to any server operated by the developer:
        </p>
        <ul>
          ...
          <li>Downloaded video files and the rendered clips produced from them</li>
          ...
          <li>OAuth access tokens and API credentials for the platforms you connect (Google, Instagram, TikTok)</li>
        </ul>
        ...
        <h2>Data Control</h2>
        <p>
          Because everything is stored locally, the operator has full control over this data at all times. Deleting
          the local database file and the application&apos;s working directory removes all stored run history,
          credentials, and generated media.
        </p>
